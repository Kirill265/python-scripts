...
worksheet_oper.write('H1', 'Доход дилера в USD', bold_blue)
...
worksheet_conv.write('I1', 'Доход дилера со сделки\n в валюте счета\n зачисления',wrap_format_bold_blue)
worksheet_conv.write('J1', 'Доход дилера со сделки\n в USD',wrap_format_bold_blue)
worksheet_conv.set_column(8, 9, 26)
...
with my_connection.cursor() as cursor:
    ...
    query = """
            ...
            , -SUM(pmd.profit*currency_convert(a.currency_id,1,pmd.created_at)) AS Profit_without_swap
