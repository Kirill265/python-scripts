...
if result_dir != '/':
    ...
    sg.one_line_progress_meter('', progress, 100, 'Запись файла:\n'+'XBRL_'+OGRN+'_ep_nso_purcb_'+repType+'_10d_reestr_0420417_'+report_date.replace("-","")+'.xml' ,size=(40,20),orientation='h', no_titlebar = True, bar_color=('#00FF00', 'White'),button_color=('White', 'Gray'))
    count_fstr = 0
