    ...
    with open(result_dir+'XBRL_'+OGRN+'_ep_nso_purcb_'+repType+'_10d_reestr_0420417_'+report_date.replace("-","")+'.xml','w',encoding='utf-8') as myXBRL:
        with open(direction+'\\temp1_XBRL_'+OGRN+'_ep_nso_purcb_'+repType+'_10d_reestr_0420417_'+report_date.replace("-","")+'.xml','r',encoding='utf-8') as temp1_XBRL:
            for line in temp1_XBRL:
                myXBRL.write(line)
        with open(direction+'\\temp2_XBRL_'+OGRN+'_ep_nso_purcb_'+repType+'_10d_reestr_0420417_'+report_date.replace("-","")+'.xml','r',encoding='utf-8') as temp1_XBRL:
            for line in temp1_XBRL:
                myXBRL.write(line)
    #shutil.copyfile(direction+"\\temp_XBRL_"+OGRN+"_ep_nso_purcb_"+repType+"_10d_reestr_0420417_"+report_date.replace("-","")+".xml", result_dir+"XBRL_"+OGRN+"_ep_nso_purcb_"+repType+"_10d_reestr_0420417_"+report_date.replace("-","")+".xml")
