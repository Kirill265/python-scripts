...
with open(getXBRL,'r',encoding='utf-8') as f_orig:
    ...
    identifier_num = 0
    instant_num = 0
    ID_strokiTypedname_num = 0
    ID_SdelkiTypedName_num = 0
...
if ID_strokiTypedname_num != count_deal:
    error_list += "Количество показателей ID_strokiTypedname и сделок расходится:\t" + str(ID_strokiTypedname_num) +"\n"
if ID_SdelkiTypedName_num != count_deal:
    error_list += "Количество показателей ID_strokiTypedname и сделок расходится:\t" + str(ID_SdelkiTypedName_num) +"\n"
