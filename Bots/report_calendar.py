...
def create_calendar(
    ...
    keyboard.add(
        InlineKeyboardButton(
            RUSSIAN_LANGUAGE.months[month - 1] + " " + str(year),
    ...
    keyboard.add(
        *[
            ...
            for day in RUSSIAN_LANGUAGE.days
        ]
    )
...
def create_months_calendar(
    ...
    for i, month in enumerate(
        zip(RUSSIAN_LANGUAGE.months[0::2], RUSSIAN_LANGUAGE.months[1::2])
    ):
        keyboard.add(
            InlineKeyboardButton(
                month[0],
...
def calendar_query_handler(
    ...
    if action == "IGNORE":
        ...
        return False, None
    elif action == "DAY" and period == False:
        return datetime.datetime(int(year), int(month), int(day))
    elif action == "DAY" and period == True:
        try:
            bot.delete_message(
