...
direction = 'C:/Users/Kirill_Cherkasov/Documents/Reports/Fresh_weekly/formulas/'
...
workbook_ = xlsxwriter.Workbook(direction+'Fresh 01-'+str(report_date.day)+' '+month+' '+str(report_date.year)+'.xlsx')
